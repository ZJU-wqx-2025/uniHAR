...
def create_io_config(args, dataset_name, version, pretrain_model=None, target='pretrain'):
    ...
    save_path = os.path.join('saved', target + "_" + "hhar" + "_" + "20_120")  # + "_temp"
    ...
    if pretrain_model is not None:
        if target.count('_') > 2: # bert_classifier
            model_path = os.path.join('saved', 'pretrain_' + target.split('_')[2] + "_" + "hhar" + "_" + "20_120", pretrain_model)# 被我修改了
        else:

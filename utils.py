...
class IMUDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        return torch.from_numpy(instance).float()
...
def handle_argv(target, config_train, prefix):
    ...
    parser.add_argument('dataset', type=str, help='Dataset name', choices=['HHAR', 'Pamap2', 'Realworld', 'UCI-HAR', 'USC-HAD'])
    parser.add_argument('dataset_version',  type=str, help='Dataset version', choices=['50_120', '20_120'])
